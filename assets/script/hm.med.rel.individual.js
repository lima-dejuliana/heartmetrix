...
//Score Geral "cba14097-60a1-1441-1547-133b1548d7ed"
//Qual geral "7dac6dca-786a-60fd-d308-2dc34fa13b3e"
...
// $.each(verificaSelecionado, function (index, sel) {
//   let arraySel = $(sel).attr('id').split('?=');
//   let dataSel = arraySel[0];
//   let emailSel = arraySel[arraySel.length - 1];
//   sessionStorage.setItem(
//     'filter',
//     JSON.stringify({ data: dataSel, email: emailSel })
//   );
// });
